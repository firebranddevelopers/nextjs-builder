...
exports.default = (function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        cacheFiles.forEach(function (absPath) {
            var base = (0, path_1.basename)(absPath);
            var canonicalName = base.match(/^\.([A-Za-z_-]+)/);
            if (!canonicalName) {
                return;
            }
            var varName = canonicalName[1];
            output.push("import ".concat(varName, " from \"./").concat(base, "\""));
            vars.push(varName);
        });
        output.push("");
