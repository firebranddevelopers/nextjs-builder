...
var getCacheDir_1 = __importDefault(require("./getCacheDir"));
var createCache = function () { return (0, file_system_cache_1.default)({ basePath: (0, getCacheDir_1.default)() }); };
var save = function (key, content) {
    createCache().setSync(key, content);
};
exports.save = save;
var saveJSON = function (key, content) {
    (0, exports.save)(key, JSON.stringify(content));
};
exports.saveJSON = saveJSON;
var writeJSONFile = function (name, content) {
...
var writeFile = function (name, content) {
    fs_1.default.writeFileSync("".concat((0, getCacheDir_1.default)(), "/").concat(name), content, "utf8");
};
